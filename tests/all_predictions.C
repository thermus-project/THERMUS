...
void prediction(TString filename)
{
   ...
   //  double B=197, Q=79, Bover2Q = B/(2*Q); if(debugMode) printf("INFO:
   //  expected colliding system: Au-Au\n");
   double B = 208, Q = 82, Bover2Q = B / (2 * Q);
   if (debugMode)
